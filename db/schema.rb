...
ActiveRecord::Schema.define(version: 2020_07_30_155155) do
  ...
  create_table "spec_attributions", force: :cascade do |t|
    t.integer "doctor_id"
    t.integer "specialty_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["doctor_id"], name: "index_spec_attributions_on_doctor_id"
    t.index ["specialty_id"], name: "index_spec_attributions_on_specialty_id"
  end
